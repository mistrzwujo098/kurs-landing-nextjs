      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-600 max-w-3xl mx-auto">
            Prosty system. <span className="font-bold text-paulina-accent">20 minut dziennie.</span> Wynik: <span className="font-bold text-paulina-primary">średnia 84% na egzaminie.</span>
          </p>
        </motion.div>
