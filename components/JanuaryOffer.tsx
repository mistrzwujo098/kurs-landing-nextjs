...
const JanuaryOffer: React.FC = () => {
  ...
  const bonuses = [
    {
      name: 'Program Ósmoklasisty 2025',
      description: 'Pełny dostęp do kursu z ponad 60 lekcjami video, 1500+ zadaniami i 30 spotkaniami live',
      value: 1997,
      icon: Star,
      highlight: true,
    },
      ...
      <div className="max-w-5xl mx-auto px-4">
        ...
        >
          ...
          <p className="text-lg text-gray-700 max-w-2xl mx-auto">
            <span className="font-bold text-paulina-accent">Ostatni moment</span> żeby zacząć przygotowania i zdążyć przed egzaminem ósmoklasisty
          </p>
        </motion.div>
